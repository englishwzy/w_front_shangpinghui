      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li
              :class="navindex === index ? 'active' : 'noactive'"
              v-for="(linav, index) in floorobj.navList"
              :key="index"
              @mouseenter="changeindex(index)"
              @mouseleave="leaveindex"
            >
              <a :href="linav.url" data-toggle="tab">
                {{ linav.text }}
              </a>
            </li>
          </ul>
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(keyword, index) in floorobj.keywords" :key="index">
                  {{ keyword }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
              <Carsouel :list="floorobj.carouselList" />
            </div>
            <div class="split">
